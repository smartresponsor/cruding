...
/**
 * Resolves service class name resolver for Cruding request processing.
 */
final class CrudServiceClassNameResolver
{
     ...
     */
    public function candidateClassNames(CrudContextDTO $context): array
    {
        return [];
    }
     ...
     */
    public function candidateShortClassNames(CrudContextDTO $context): array
    {
     ...
     * @return list<non-empty-string>
     */
    public function candidateServiceIds(CrudContextDTO $context): array
    {
        return [];
    }
     ...
     * @return list<non-empty-string>
     */
    public function candidateServiceNamespaceRootPrefixes(CrudContextDTO $context): array
    {
        $namespaceRoots = [];
