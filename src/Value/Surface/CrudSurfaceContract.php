...
final readonly class CrudSurfaceContract
{
    ...
    public static function forSurface(
        ...
        return new self(
            ...
            self::defaultSlotMap(),
            [
                'title' => is_scalar($meta['title'] ?? null) ? (string) $meta['title'] : 'Cruding surface',
                'component' => 'cruding',
    ...
    {
        return [
            'top' => 'Top surface area',
            'left' => 'Left surface area',
            'body' => 'Body surface area',
            'right' => 'Right surface area',
            'bottom' => 'Bottom surface area',
            'stickyTop' => 'Sticky top surface area',
            'stickyBottom' => 'Sticky bottom surface area',
            'tool' => 'Tool surface area',
            'filter' => 'Filter surface area',
            'menu' => 'Menu surface area',
            'diagnostic' => 'Diagnostic surface area',
            'top.search' => 'Search',
