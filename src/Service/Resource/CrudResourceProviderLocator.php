...
/**
 * Provides the resource provider locator responsibility within the Cruding component.
 */
final class CrudResourceProviderLocator
{
    ...
    public function locate(CrudRouteContextDTO $context): ?CrudResourceProviderInterface
    {
