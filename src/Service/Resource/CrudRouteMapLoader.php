...
use App\Cruding\DTO\Resource\CrudRouteMapEntryDTO;
...
final readonly class CrudRouteMapLoader
{
    ...
    /**
     * @return list<CrudRouteMapEntryDTO>
     */
    ...
    private function entryFromLine(string $line): ?CrudRouteMapEntryDTO
    {
        $line = trim($line);
        ...
        return new CrudRouteMapEntryDTO(
