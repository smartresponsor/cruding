...
use App\Cruding\Dto\Resource\CrudResourceBlock;
...
final class CrudResourcePayloadBuilder
{
    ...
    public static function fromRequest(CrudResourceRequest $request): self
    {
    ...
    {
        return $this->viewBlock($location, new CrudResourceBlock(
    ...
    public function viewBlock(string $location, CrudResourceBlock $block): self
    {
