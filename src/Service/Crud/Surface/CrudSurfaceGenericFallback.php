...
final readonly class CrudSurfaceGenericFallback
{
    ...
    public function provide(CrudRouteContext $routeContext): ?CrudSurfaceContract
    {
        ...
        if ('index' === $crudContext->operation) {
            return $this->surfaceContractFactory->create($this->pageDefinitionProvider->provideIndex($crudContext));
        }
        ...
        return $this->surfaceContractFactory->create($this->pageDefinitionProvider->provideShow($crudContext, $object), $object);
    }
}
