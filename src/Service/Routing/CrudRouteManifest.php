...
namespace App\Cruding\Service\Routing;
 ...
 */
final class CrudRouteManifest extends Loader
{
    ...
    public function load(mixed $resource, ?string $type = null): RouteCollection
    {
        if ($this->exists()) {
            try {
                ...
                error_log('[cruding] route manifest load failed; falling back to live routes: '.$error->getMessage());
            }
        }
