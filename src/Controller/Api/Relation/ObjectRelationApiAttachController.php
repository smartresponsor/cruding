...
final class ObjectRelationApiAttachController extends AbstractController
{
    ...
    public function __invoke(Request $request): Response
    {
        ...
        $relation = $this->relationManager->attach($context, $subject);

        return $this->responder->apiAttached($context, $subject, $relation);
    }
}
