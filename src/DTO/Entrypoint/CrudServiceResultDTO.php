...
/**
 * Carries service result data across Cruding processing boundaries.
 */
final readonly class CrudServiceResultDTO
{
    ...
    /**      * Executes the should continue default operation.      */
    public function shouldContinueDefault(): bool
    {
        return $this->continueDefault;
    }

    /**      * Indicates whether payload.      */
