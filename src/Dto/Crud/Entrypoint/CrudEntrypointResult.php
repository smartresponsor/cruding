...
final readonly class CrudEntrypointResult
{
    ...
    public static function surfaceContract(CrudSurfaceContract $contract, string $status = self::STATUS_SURFACE_CONTRACT, array $diagnostics = []): self
    {
    ...
    {
        return null !== $this->response || null !== $this->surfaceContract;
    }

    public function payload(): Response|CrudSurfaceContract|null
    {
        return $this->response ?? $this->surfaceContract;
    }
}
