...
final class CrudResourceWorkbenchBuilder
{
     ...
     */
    public function build(CrudPageDefinitionDTO $page, array $rows, array $columns, array $filters, array $formFields, array $actions, string $resourcePath, string $component, string $operation): array
    {
