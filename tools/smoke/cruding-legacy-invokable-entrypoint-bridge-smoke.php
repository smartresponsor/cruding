...
$resolverPath = $root.'/src/Resolver/CrudServiceResolver.php';
...
assert(str_contains($invoker, 'CrudServiceResultDTO::STATUS_LEGACY_INVOKABLE_FAILED'), 'Legacy invokable exceptions must degrade to continue-default diagnostics.');
