...
require_once $root.'/src/Parser/CrudResourcePathParser.php';
require_once $root.'/src/Resolver/CrudEntityClassResolver.php';
...
$source = file_get_contents($root.'/src/Resolver/CrudEntityClassResolver.php');
