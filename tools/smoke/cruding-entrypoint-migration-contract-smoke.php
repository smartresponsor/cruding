...
assert(str_contains($skeletonOutput, 'final class AlphaAttachmentMediaArchiveService extends CrudAbstractService'), 'Skeleton preview must generate a self-documenting abstract-based entrypoint.');
