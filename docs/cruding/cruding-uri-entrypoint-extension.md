...
These classes are extension points, not controllers. They may be empty, extend `CrudAbstractService`, or implement one or more optional entrypoint interfaces.
...
```php
final class AlphaIndexService extends CrudAbstractService
{
}
```
