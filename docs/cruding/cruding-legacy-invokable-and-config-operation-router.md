...
- `get(CrudServiceContextDTO $context)`
- `post(CrudServiceContextDTO $context)`
- `put(CrudServiceContextDTO $context)`
- `patch(CrudServiceContextDTO $context)`
- `delete(CrudServiceContextDTO $context)`
